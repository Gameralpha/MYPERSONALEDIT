...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! lunauxd Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("Official_Devil_Network")
            await ASS_CLI_1.join_chat("Official_Devil_Support")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("Official_Devil_Network")
            await ASS_CLI_2.join_chat("Official_Devil_Support")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("Official_Devil_Network")
            await ASS_CLI_3.join_chat("Official_Devil_Support")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("Official_Devil_Network")
            await ASS_CLI_4.join_chat("Official_Devil_Support")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("Official_Devil_Network")
            await ASS_CLI_5.join_chat("Official_Devil_Support")
        except:
            pass
